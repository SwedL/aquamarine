...
urlpatterns = [
    ...
    path('request-call-processing/<int:days_delta>/<int:call_pk>/', RequestCallProcessingView.as_view(),
    ...
    path('user-reg-cancel/<int:registration_pk>/', UserRegistrationsCancelView.as_view(),
