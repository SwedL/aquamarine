...
* **api/v1/carwash-user-registration-list/\<int:id>/** - DELETE запрос на удаление записи пользователя, указанной в запросе. <ins>Требуется авторизация пользователя</ins>. 
