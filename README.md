...
**Первый** — это публичная часть: <br>Главная страница сайта, где можно узнать о работе компании и её преимуществах перед конкурентами, заказать звонок от компании. 
...
**Второй** интерфейс предназначен для менеджера или администратора. Здесь менеджер видит записи клиентов (какой автомобиль, какие выбраны услуги и контакты клиента).
...
**Третий** интерфейс — это админ-панель. Сюда имеет доступ только администратор.
Для обновления услуг и их цен, а также просмотра истории всех записей клиентов, в течении года.
