...
class UserModelTestCase(TestCase):
    ...
    def test_fields(self):
        ...
        self.assertEqual(field_email.verbose_name, 'Логин')
        self.assertEqual(field_email.max_length, 255)
        self.assertEqual(field_fio.verbose_name, 'ФИО')
        self.assertEqual(field_fio.max_length, 255)
        self.assertEqual(field_phone_number.verbose_name, 'телефон')
        self.assertEqual(field_phone_number.max_length, 11)
        self.assertEqual(field_car_type.verbose_name, 'тип автомобиля')
        self.assertEqual(field_car_type.max_length, 40)
        self.assertEqual(field_car_model.verbose_name, 'марка и модель автомобиля')
        self.assertEqual(field_car_model.max_length, 150)
        self.assertEqual(field_discount.verbose_name, 'дисконт')
        self.assertEqual(field_discount.default, 0)
        self.assertEqual(field_user_creation_date.verbose_name, 'дата регистрации пользователя')
